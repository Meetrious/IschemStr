...
namespace StraightTask
{
	...
	public:
		...
		// Solves the straight task and outputs solution -- it is defined in Solver.h
		void SolveAndOutput(uint32_t N, double_t GapWidth, uint16_t full_amount_of_gaps);

		// Solves the straight task three times and calculates the order of assignated num-method using Runge-rule -- it is defined in Solver.h
